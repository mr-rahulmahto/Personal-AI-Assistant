...
# Asynchronous function to an audio file
        ...
        try:
            ...
            while pygame.mixer.music.get_busy():
                if func() ==False: #Check if the external function return False
                    break
                pygame.time.Clock().tick(10) #Limit the loop to 10 tick pere second
            ...
            try:
                #Call the provided with False to signal the end of TTS
                func(False)
...
def TextToSpeech(Text , func=lambda r=None: True):
    ...
    #List of provider response for cases where the text is too long
    ...
    #if the text is very long (more than 4 sentences and 300 characters) , add a respones messages
...
if __name__ == "__main__":
    while True:
        ...
        #  TextToSpeech(input("Enter the Text: "))
         TTS(input("Enter the Text: ")) # you speak whole text you are use TTS function